...
def main(window):
    ...
    # Create platforms and obstacles inspired by Mario Bros
    ...
    enemies = [
        Enemy(block_size * 7, HEIGHT - block_size - 50, 40, 50),
        Enemy(block_size * 12, HEIGHT - block_size - 50, 40, 50)
    ]

    objects = [*floor, *platforms, fire, *enemies]
